...
- **Fixture-export COMPLETE (fx window, 2026-07-12)** — see the Fixture-export block below. **Next: Step 8 Increment 1** (domain/types.ts, data/provider.ts) against the committed fixtures.
