...
### Verified baseline — as of 2026-07-11, code HEAD `523c977` (bug-set extension complete), doc commits may sit on top (judged from code + DB, not from checkboxes)
...
- **Next: fixture-export** (open design point below), then Step 8.
